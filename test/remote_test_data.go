...
func LoadTestData(filename string, provider TestDataProvider) ([]byte, error) {
	...
	// Get path to src/github.com/fabric8io/almighty-core/test/remote_test_data.go
	_, packagefilename, _, ok := runtime.Caller(0)
	if !ok {
		panic("No caller information")
	}

	// The target dir would be src/github.com/fabric8io/almighty-core/examples/test
